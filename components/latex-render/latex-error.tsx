...
function parseLatexError(error: string): string {
  const errorMessages: { [key: string]: string } = {
    ...
    "Missing File: No main.tex or main.typ file found": "Missing File: No main.tex or main.typ file found\n\nDetails: A main.tex (LaTeX) or main.typ (Typst) file is required for compilation.",
  };
...
export default function LatexError({ error }: { error: string }) {
  ...
  return (
    <Alert variant="destructive" className="m-4">
      ...
      <AlertTitle className="text-red-600 dark:text-red-200">Compilation Error</AlertTitle>
