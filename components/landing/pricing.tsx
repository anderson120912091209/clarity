        ...
        <div className="grid grid-cols-2 gap-3 md:gap-6">
          <div className="rounded-xl md:rounded-2xl border border-white/10 bg-[#0d0d0f] p-4 md:p-8">
            <div className="mb-4 md:mb-6">
              <p className="text-zinc-300 text-[10px] md:text-sm uppercase tracking-wide">Free</p>
              <h3 className="text-2xl md:text-4xl font-semibold text-white mt-1 md:mt-2">$0</h3>
              <p className="text-zinc-400 mt-1 md:mt-2 text-[10px] md:text-base leading-tight">For drafting and previews.</p>
            </div>
          ...
          transition-all">
            ...
            <div className="relative z-10">
              <div className="mb-4 md:mb-6">
                ...
                <p className="text-zinc-300 mt-1 md:mt-2 text-[10px] md:text-base leading-tight">For serious research.</p>
              </div>
